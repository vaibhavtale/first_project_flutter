    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(8), vertical: AppLayout.getHeight(3)),
                    child: Row(
                      children: [
                        Container(
          ...
          Container(
            padding: EdgeInsets.symmetric(horizontal: AppLayout.getWidth(13)),
            decoration: BoxDecoration(
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                    AppColumnLayout(firstText: "24 039", secondText: "Miles", alignment: CrossAxisAlignment.start, isColor: false,),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                    AppColumnLayout(firstText: "384 99", secondText: "Miles", alignment: CrossAxisAlignment.start, isColor: false,),
                    AppColumnLayout(firstText: "Mc Donalds", secondText: "Recieved from", alignment: CrossAxisAlignment.end, isColor: false,)
                  ],
                ),
                ...
                Row(
                  ...
                  children: const [
                    ...
                    AppColumnLayout(firstText: "dBestech", secondText: "Recieved from", alignment: CrossAxisAlignment.end, isColor: false,)
                  ],
                ),
